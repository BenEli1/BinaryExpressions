...
public class Nor extends BinaryExpression  {
    ...
    public String toString() {
        return ("(" + getX().toString() + " V " + getY().toString() + ")");
    }
    /**
    ...
    public Expression assign(String var, Expression expression) {
        return new Nor(getX().assign(var, expression), getY().assign(var, expression));
    }
    /**
     * nandify method.
    ...
    public Expression nandify() {
        ...
        return new Nand(new Nand(new Nand(nandX, nandX), new Nand(nandY, nandY)),
                new Nand(new Nand(nandX, nandX), new Nand(nandY, nandY)));
    }
    /**
     * noritfy method.
    ...
    public Expression simplify() {
        ...
        Expression simpleExp = new Nor(getX().simplify(), getY().simplify());
        ...
        if (strX.equals("T") || strX.equals("F")) {
            if (strY.equals("T") || strY.equals("F")) {
                try {
                    return new Val(new Nor(getX().simplify(), getY().simplify()).evaluate());
                } catch (Exception e) {
