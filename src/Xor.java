...
public class Xor extends BinaryExpression {
    ...
    public Expression assign(String var, Expression expression) {
        return new Xor(getX().assign(var, expression), getY().assign(var, expression));
    }
    /**
     * nandify method.
    ...
    public Expression nandify() {
        ...
        return new Nand(new Nand(nandX, new Nand(nandX, nandY)), new Nand(nandY, new Nand(nandX, nandY)));
    }
    /**
     * noritfy method.
    ...
    public Expression norify() {
        ...
        return new Nor(new Nor(new Nor(norX, norX), new Nor(norY, norY)), new Nor(norX, norY));
    }
    ...
    public Expression simplify() {
        ...
        Expression simpleExp = new Xor(getX().simplify(), getY().simplify());
        ...
        if (strX.equals("T") || strX.equals("F")) {
            if (strY.equals("T") || strY.equals("F")) {
                try {
                    return new Val(new Xor(getX().simplify(), getY().simplify()).evaluate());
                } catch (Exception e) {
