 ...
 * And class which is a binary expression that evaulets using && opreator.
 */
public class And extends BinaryExpression {
    ...
    public Expression assign(String var, Expression expression) {
        return new And(getX().assign(var, expression), getY().assign(var, expression));
    }
    /**
     * nandify method.
    ...
    public Expression nandify() {
        ...
        return new Nand(new Nand(nandX, nandY), new Nand(nandX, nandY));
    }
    /**
     * noritfy method.
    ...
    public Expression norify() {
        ...
        return new Nor(new Nor(norX, norX), new Nor(norY, norY));
    }
    ...
    public Expression simplify() {
        ...
        Expression simpleExp = new And(getX().simplify(), getY().simplify());
        ...
        if (strX.equals("T") || strX.equals("F")) {
            if (strY.equals("T") || strY.equals("F")) {
                try {
                    return new Val(new And(getX().simplify(), getY().simplify()).evaluate());
                } catch (Exception e) {
        ...
        return new And(getX().simplify(), getY().simplify());
    }
    /**
     * toString method.
